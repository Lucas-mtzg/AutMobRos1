...
class PathPlanner : public Block   // Set the number of inputs and outputs
{
public:
    ...
    PathPlanner(double k1, double k2, double k3, double tolPos = 5e-3, double tolRot = M_PI / 1000.0, double xT = 0, double yT = 0,
                double phiT = 0) 
    : k1(k1), 
      k2(k2), 
      k3(k3),
      ...
      yT(yT),
      phiT(phiT),
      GrR(this),            // Input of the block, global robot position
      phi(this),            // Input of the block, global robot orientation
      targetReached(true),
      enabled(false),
      RvRx_d(this),         // Output of the block, desired linear velocity
      omegaR_d(this)        // Output of the block, desired angular velocity
